...
// .3e-4
// 1.e+5
FLOAT_NUMBER:   ((DIGITS? DOT_SYMBOL)? DIGITS | DIGITS DOT_SYMBOL) [eE] (MINUS_OPERATOR | PLUS_OPERATOR)? DIGITS;
...
ADDDATE_SYMBOL:                  A D D D A T E                               { l.SetType(l.DetermineFunction(TiDBLexerADDDATE_SYMBOL)); }; // MYSQL-FUNC
...
AUTO_RANDOM_SYMBOL:              A U T O '_' R A N D O M                     ;
...
BIT_AND_SYMBOL:                  B I T '_' A N D                             { l.SetType(l.DetermineFunction(TiDBLexerBIT_AND_SYMBOL)); }; // MYSQL-FUNC
BIT_OR_SYMBOL:                   B I T '_' O R                               { l.SetType(l.DetermineFunction(TiDBLexerBIT_OR_SYMBOL)); }; // MYSQL-FUNC
BIT_SYMBOL:                      B I T;                                      // MYSQL-FUNC
BIT_XOR_SYMBOL:                  B I T '_' X O R                             { l.SetType(l.DetermineFunction(TiDBLexerBIT_XOR_SYMBOL)); }; // MYSQL-FUNC
...
CAST_SYMBOL:                     C A S T                                     { l.SetType(l.DetermineFunction(TiDBLexerCAST_SYMBOL)); }; // SQL-2003-R
...
COUNT_SYMBOL:                    C O U N T                                   { l.SetType(l.DetermineFunction(TiDBLexerCOUNT_SYMBOL)); }; // SQL-2003-N
CPU_SYMBOL:                      C P U;
CREATE_SYMBOL:                   C R E A T E;                                // SQL-2003-R
CROSS_SYMBOL:                    C R O S S;                                  // SQL-2003-R
CUBE_SYMBOL:                     C U B E;                                    // SQL-2003-R
CURDATE_SYMBOL:                  C U R D A T E                               { l.SetType(l.DetermineFunction(TiDBLexerCURDATE_SYMBOL)); }; // MYSQL-FUNC
CURRENT_SYMBOL:                  C U R R E N T                               ;
CURRENT_DATE_SYMBOL:
    C U R R E N T '_' D A T E                                                { l.SetType(l.DetermineFunction(TiDBLexerCURDATE_SYMBOL)); }
;                                                                            // Synonym, MYSQL-FUNC
CURRENT_TIME_SYMBOL:
    C U R R E N T '_' T I M E                                                { l.SetType(l.DetermineFunction(TiDBLexerCURTIME_SYMBOL)); }
;                                                                            // Synonym, MYSQL-FUNC
...
CURTIME_SYMBOL:                  C U R T I M E                               { l.SetType(l.DetermineFunction(TiDBLexerCURTIME_SYMBOL)); }; // MYSQL-FUNC
...
DATE_ADD_SYMBOL:                 D A T E '_' A D D                           { l.SetType(l.DetermineFunction(TiDBLexerDATE_ADD_SYMBOL)); };
DATE_SUB_SYMBOL:                 D A T E '_' S U B                           { l.SetType(l.DetermineFunction(TiDBLexerDATE_SUB_SYMBOL)); };
...
DEFAULT_AUTH_SYMBOL:             D E F A U L T '_' A U T H                   ;
...
EXTRACT_SYMBOL:                  E X T R A C T                               { l.SetType(l.DetermineFunction(TiDBLexerEXTRACT_SYMBOL)); }; // SQL-2003-N
...
GROUP_CONCAT_SYMBOL:
    G R O U P '_' C O N C A T                                                { l.SetType(l.DetermineFunction(TiDBLexerGROUP_CONCAT_SYMBOL)); }
;
...
;
MAX_SYMBOL:                      M A X                                       { l.SetType(l.DetermineFunction(TiDBLexerMAX_SYMBOL)); }; // SQL-2003-N
...
MID_SYMBOL:                      M I D                                       { l.SetType(l.DetermineFunction(TiDBLexerSUBSTRING_SYMBOL)); }; // Synonym
...
MIN_SYMBOL:                      M I N                                       { l.SetType(l.DetermineFunction(TiDBLexerMIN_SYMBOL)); }; // SQL-2003-N
MODE_SYMBOL:                     M O D E;
...
NOT_SYMBOL:
    N O T
;                                                                            // SQL-2003-R
NOW_SYMBOL:                      N O W                                       { l.SetType(l.DetermineFunction(TiDBLexerNOW_SYMBOL)); };
...
PORT_SYMBOL:                     P O R T;
POSITION_SYMBOL:                 P O S I T I O N                             { l.SetType(l.DetermineFunction(TiDBLexerPOSITION_SYMBOL)); }; // SQL-2003-N
...
SESSION_USER_SYMBOL:
    S E S S I O N '_' U S E R                                                { l.SetType(l.DetermineFunction(TiDBLexerUSER_SYMBOL)); }
;                                                                            // Synonym
...
STDDEV_SAMP_SYMBOL:
    S T D D E V '_' S A M P                                                  { l.SetType(l.DetermineFunction(TiDBLexerSTDDEV_SAMP_SYMBOL)); }
;                                                                            // SQL-2003-N
STDDEV_SYMBOL:                   S T D D E V                                 { l.SetType(l.DetermineFunction(TiDBLexerSTD_SYMBOL)); }; // Synonym
STDDEV_POP_SYMBOL:               S T D D E V '_' P O P                       { l.SetType(l.DetermineFunction(TiDBLexerSTD_SYMBOL)); }; // Synonym
STD_SYMBOL:                      S T D                                       { l.SetType(l.DetermineFunction(TiDBLexerSTD_SYMBOL)); };
STOP_SYMBOL:                     S T O P;
...
SUBDATE_SYMBOL:                  S U B D A T E                               { l.SetType(l.DetermineFunction(TiDBLexerSUBDATE_SYMBOL)); };
SUBJECT_SYMBOL:                  S U B J E C T;
SUBPARTITIONS_SYMBOL:            S U B P A R T I T I O N S;
SUBPARTITION_SYMBOL:             S U B P A R T I T I O N;
SUBSTR_SYMBOL:                   S U B S T R                                 { l.SetType(l.DetermineFunction(TiDBLexerSUBSTRING_SYMBOL)); }; // Synonym
SUBSTRING_SYMBOL:                S U B S T R I N G                           { l.SetType(l.DetermineFunction(TiDBLexerSUBSTRING_SYMBOL)); }; // SQL-2003-N
SUM_SYMBOL:                      S U M                                       { l.SetType(l.DetermineFunction(TiDBLexerSUM_SYMBOL)); }; // SQL-2003-N
SUPER_SYMBOL:                    S U P E R;
SUSPEND_SYMBOL:                  S U S P E N D;
SWAPS_SYMBOL:                    S W A P S;
SWITCHES_SYMBOL:                 S W I T C H E S;
SYSDATE_SYMBOL:                  S Y S D A T E                               { l.SetType(l.DetermineFunction(TiDBLexerSYSDATE_SYMBOL)); };
SYSTEM_USER_SYMBOL:              S Y S T E M '_' U S E R                     { l.SetType(l.DetermineFunction(TiDBLexerUSER_SYMBOL)); };
...
TRIM_SYMBOL:                     T R I M                                     { l.SetType(l.DetermineFunction(TiDBLexerTRIM_SYMBOL)); }; // SQL-2003-N
...
VARIANCE_SYMBOL:                 V A R I A N C E                             { l.SetType(l.DetermineFunction(TiDBLexerVARIANCE_SYMBOL)); };
VARYING_SYMBOL:                  V A R Y I N G;                              // SQL-2003-R
VAR_POP_SYMBOL:                  V A R '_' P O P                             { l.SetType(l.DetermineFunction(TiDBLexerVARIANCE_SYMBOL)); }; // Synonym
VAR_SAMP_SYMBOL:                 V A R '_' S A M P                           { l.SetType(l.DetermineFunction(TiDBLexerVAR_SAMP_SYMBOL)); };
...
COMPONENT_SYMBOL:                C O M P O N E N T                           ;
...
PERSIST_ONLY_SYMBOL:             P E R S I S T '_' O N L Y                   ;
HISTOGRAM_SYMBOL:                H I S T O G R A M                           ;
BUCKETS_SYMBOL:                  B U C K E T S                               ;
REMOTE_SYMBOL:                   R E M O T E                                 ;
...
PATH_SYMBOL:                     P A T H                                     ;
HISTORY_SYMBOL:                  H I S T O R Y                               ;
REUSE_SYMBOL:                    R E U S E                                   ;
SRID_SYMBOL:                     S R I D                                     ;
THREAD_PRIORITY_SYMBOL:          T H R E A D '_' P R I O R I T Y             ;
RESOURCE_SYMBOL:                 R E S O U R C E                             ;
SYSTEM_SYMBOL:                   S Y S T E M                                 ;
VCPU_SYMBOL:                     V C P U                                     ;
...
;                                                                            // MYSQL
RESTART_SYMBOL:                  R E S T A R T                               ;
DEFINITION_SYMBOL:               D E F I N I T I O N                         ;
DESCRIPTION_SYMBOL:              D E S C R I P T I O N                       ;
ORGANIZATION_SYMBOL:             O R G A N I Z A T I O N                     ;
REFERENCE_SYMBOL:                R E F E R E N C E                           ;

OPTIONAL_SYMBOL:                 O P T I O N A L                             ;
SECONDARY_SYMBOL:                S E C O N D A R Y                           ;
SECONDARY_ENGINE_SYMBOL:         S E C O N D A R Y '_' E N G I N E           ;
SECONDARY_LOAD_SYMBOL:           S E C O N D A R Y '_' L O A D               ;
SECONDARY_UNLOAD_SYMBOL:         S E C O N D A R Y '_' U N L O A D           ;

ACTIVE_SYMBOL:                   A C T I V E                                 ;
INACTIVE_SYMBOL:                 I N A C T I V E                             ;
LATERAL_SYMBOL:                  L A T E R A L                               ;
RETAIN_SYMBOL:                   R E T A I N                                 ;
OLD_SYMBOL:                      O L D                                       ;

NETWORK_NAMESPACE_SYMBOL:        N E T W O R K '_' N A M E S P A C E         ;
ENFORCED_SYMBOL:                 E N F O R C E D                             ;
...
// Unreversed keywords.
// Should add into the indentifierKeyword

S3_SYMBOL:              S '3'                                       ; // For AWS RDS MySQL
INVOKE_SYMBOL:          I N V O K E                                 ; // For AWS RDS MySQL
LAMBDA_SYMBOL:          L A M B D A                                 ; // For AWS RDS MySQL
